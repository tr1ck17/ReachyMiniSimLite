"""
Reachy Mini Solar System Program (Lite / USB)

This version targets Reachy Mini Lite connected over USB.
The SDK auto-detects the local daemon when using ReachyMini().
"""
